    ...
    return (
      <div className="app-header qilin-panel">
        ...
        <div className="app-header-buttons">
          <button className={themeButton} onClick={this.props.toggleTheme}>
            <ReactSVG
              className="qilin-button-icon"
              path={require("../../images/icons/menu/theme.svg")}
            />
          </button>

          <button className={formulaButton} onClick={this.props.toggleFormula}>
            <ReactSVG
              className="qilin-button-icon"
              path={require("../../images/icons/menu/formula.svg")}
            />
          </button>

          <button className={previewButton} onClick={this.props.togglePreview}>
            <ReactSVG
              className="qilin-button-icon"
              path={require("../../images/icons/menu/preview.svg")}
            />
          </button>
        </div>
      </div>
